...
async function getsongs(folder) {
    currfolder = folder;
    let a = await fetch(`/songs/${encodeURIComponent(currfolder)}/`);
...
async function main() {
    ...
    let folderarray = await fetch("/songs/");
    ...
    for (let k = 0; k < songfollst.length; k++) {
        ...
        cardDiv.innerHTML = `
            <div class="cardimg">
                <img src="tool/cardimg/img${k}.jpg" id="cardimgid" alt="card img">
                <div class="play">
